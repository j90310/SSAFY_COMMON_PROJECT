...
class BuyPartyList extends StatefulWidget {
  @override
  State<BuyPartyList> createState() => _BuyPartyListState();
}

class _BuyPartyListState extends State<BuyPartyList> {
